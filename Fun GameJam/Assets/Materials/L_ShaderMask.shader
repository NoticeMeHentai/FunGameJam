...
Shader "L_ShaderMask"
{
	Properties
	{
		_SignalPos("SignalPos", Vector) = (0,0,0,0)
		_Float4("Float 4", Float) = 0.5
		_Float0("Float 0", Float) = -0.1
		_MaxDist("MaxDist", Float) = 10
		_SignalBigDisconnectionBool("SignalBigDisconnectionBool", Float) = 0
	...
	SubShader
	{
		...
		uniform float _SignalBigDisconnectionBool;
		uniform float4 _SignalPos;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 appendResult100 = (float2(_SignalPos.x , _SignalPos.z));
			...
			if( _SignalBigDisconnectionBool > 0.5 )
...
/*ASEBEGIN
Version=16600
44;262;1828;836;1333.957;-9.801758;1;True;False
...
Node;AmplifyShaderEditor.Vector4Node;6;-2685.409,606.8173;Float;False;Property;_SignalPos;SignalPos;0;0;Create;True;0;0;False;0;0,0,0,0;0,10,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-2133.215,1614.622;Float;False;Property;_MaxDist;MaxDist;4;0;Create;True;0;0;False;0;10;2;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=CDA0D8E748B563A2132DE08309FDC0C7DCF9C929