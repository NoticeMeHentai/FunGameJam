...
Shader "L_ShaderMask"
{
	...
	SubShader
	{
		...
		{
			float4 color3 = IsGammaSpace() ? float4(0.4811321,0.2214253,0,0) : float4(0.196991,0.04017728,0,0);
...
/*ASEBEGIN
Version=16600
-9;370;1828;948;1224;588.5;1;True;False
Node;AmplifyShaderEditor.VertexColorNode;1;-880,-160.5;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=2097AAC6786278B3A7A70CB78599A868C321B960